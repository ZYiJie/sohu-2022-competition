...
def main():
    ...
    parser.add_argument('--train_input_path', type=str, default="data/generated_random_train.txt",
    ...
    parser.add_argument('--pretrained_path', type=str, required=False,
                        default="/home/yjw/ZYJ_WorkSpace/PTMs/chinese-roberta-wwm-ext/")
    ...
    parser.add_argument('--kflod', default=5, type=int, required=False, help='k折交叉折数')
